...
NBaseRoundProgressBar::NBaseRoundProgressBar(QWidget *parent)
    : QWidget(parent),
      m_min(0),
      m_max(100),
      m_value(25),
...
double NBaseRoundProgressBar::nullPosition() const {
    return m_nullPosition;
}

void NBaseRoundProgressBar::setNullPosition(double position)
{
...
void NBaseRoundProgressBar::setBarStyle(NBaseRoundProgressBar::BarStyle style)
{
    if (style != m_barStyle)
    {
        m_barStyle = style;
...
NBaseRoundProgressBar::BarStyle NBaseRoundProgressBar::barStyle() const {
    return m_barStyle;
}

void NBaseRoundProgressBar::setOutlinePenWidth(double penWidth)
{
...
double NBaseRoundProgressBar::outlinePenWidth() const {
    return m_outlinePenWidth;
}

void NBaseRoundProgressBar::setDataPenWidth(double penWidth)
{
...
double NBaseRoundProgressBar::dataPenWidth() const {
    return m_dataPenWidth;
}

void NBaseRoundProgressBar::setDataColors(const QGradientStops &stopPoints)
{
...
void NBaseRoundProgressBar::setFormat(const QString &format)
{
    if (format != m_format)
    {
        m_format = format;
...
void NBaseRoundProgressBar::resetFormat()
{
    m_format = QString::null;
    valueFormatChanged();
}

QString NBaseRoundProgressBar::format() const {
    return m_format;
}

void NBaseRoundProgressBar::setDecimals(int count)
{
...
int NBaseRoundProgressBar::decimals() const {
    return m_decimals;
}

double NBaseRoundProgressBar::value() const {
    return m_value;
}

double NBaseRoundProgressBar::minimum() const {
    return m_min;
}

double NBaseRoundProgressBar::maximum() const {
    return m_max;
}

void NBaseRoundProgressBar::setRange(double min, double max)
{
    m_min = min;
    m_max = max;
...
void NBaseRoundProgressBar::setMinimum(double min)
{
    setRange(min, m_max);
}

void NBaseRoundProgressBar::setMaximum(double max)
{
    setRange(m_min, max);
}

void NBaseRoundProgressBar::setValue(double val)
{
    if (m_value != val)
    {
        if (val < m_min)
...
void NBaseRoundProgressBar::setValue(int val)
{
    setValue(double(val));
}

void NBaseRoundProgressBar::paintEvent(QPaintEvent *event)
{
    Q_UNUSED(event)
...
void NBaseRoundProgressBar::drawBackground(QPainter &p, const QRectF &baseRect)
{
    p.fillRect(baseRect, palette().background());
}

void NBaseRoundProgressBar::drawBase(QPainter &p, const QRectF &baseRect)
{
    switch (m_barStyle)
    {
    case StyleDonut:
...
void NBaseRoundProgressBar::drawValue(QPainter &p, const QRectF &baseRect, double value, double arcLength)
{
    // nothing to draw
    if (value == m_min)
        return;
...
void NBaseRoundProgressBar::calculateInnerRect(const QRectF &baseRect, double outerRadius, QRectF &innerRect, double &innerRadius)
{
    Q_UNUSED(baseRect)
    // for Line style
    if (m_barStyle == StyleLine)
...
void NBaseRoundProgressBar::drawInnerBackground(QPainter &p, const QRectF &innerRect)
{
...
void NBaseRoundProgressBar::drawText(QPainter &p, const QRectF &innerRect, double innerRadius, double value)
{
    if (m_format.isEmpty())
        return;
    // !!! to revise
...
QString NBaseRoundProgressBar::valueToText(double value) const
{
...
void NBaseRoundProgressBar::valueFormatChanged()
{
    m_updateFlags = 0;
...
void NBaseRoundProgressBar::rebuildDataBrushIfNeeded()
{
    if (m_rebuildBrush)
    {
        m_rebuildBrush = false;
